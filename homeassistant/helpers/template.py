...
class DomainStates:
    ...
    def __getattr__(self, name):
        """Return the states."""
        return _wrap_state(self._hass.states.get("{}.{}".format(self._domain, name)))
    ...
    def closest(self, *args):
        ...
        if isinstance(entities, (AllStates, DomainStates)):
            ...
            states = [
                ...
                for entity_id in group.expand_entity_ids([gr_entity_id])
            ]
    ...
    def distance(self, *args):
        ...
        while to_process:
            ...
            if isinstance(value, State):
                ...
                if latitude is None or longitude is None:
                    _LOGGER.warning(
                        "Distance:State does not contains a location: %s", value
                    )
                    return None
