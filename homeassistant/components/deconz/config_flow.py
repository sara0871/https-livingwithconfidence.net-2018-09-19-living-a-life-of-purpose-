...
from .const import CONF_ALLOW_DECONZ_GROUPS, CONF_ALLOW_CLIP_SENSOR, CONFIG_FILE, DOMAIN
...
class DeconzFlowHandler(data_entry_flow.FlowHandler):
    ...
    async def async_step_options(self, user_input=None):
        ...
        if user_input is not None:
            self.deconz_config[CONF_ALLOW_CLIP_SENSOR] = user_input[
                CONF_ALLOW_CLIP_SENSOR
            ]
            self.deconz_config[CONF_ALLOW_DECONZ_GROUPS] = user_input[
    ...
    async def async_step_discovery(self, discovery_info):
        ...
        if (
            config_file
            and config_file[CONF_HOST] == deconz_config[CONF_HOST]
            and CONF_API_KEY in config_file
        ):
    ...
    async def async_step_import(self, import_config):
        ...
        user_input = {CONF_ALLOW_CLIP_SENSOR: True, CONF_ALLOW_DECONZ_GROUPS: True}
