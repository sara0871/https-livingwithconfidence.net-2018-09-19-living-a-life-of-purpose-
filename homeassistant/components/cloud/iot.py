    ...
    def connect(self):
        ...
        while True:
            ...
            try:
                ...
                self.retry_task = hass.async_add_job(
                    asyncio.sleep(2 ** min(9, self.tries), loop=hass.loop)
                )
    ...
    def _handle_connection(self):
        ...
        try:
            ...
            hass.components.persistent_notification.async_create(
                MESSAGE_AUTH_FAIL, "Home Assistant Cloud", "cloud_subscription_expired"
            )
        ...
        if self.cloud.subscription_expired:
            hass.components.persistent_notification.async_create(
                MESSAGE_EXPIRATION, "Home Assistant Cloud", "cloud_subscription_expired"
            )
...
def async_handle_alexa(hass, cloud, payload):
    ...
    result = yield from alexa.async_handle_message(hass, cloud.alexa_config, payload)
    return result
...
def async_handle_google_actions(hass, cloud, payload):
    ...
    result = yield from ga.async_handle_message(hass, cloud.gactions_config, payload)
    return result
