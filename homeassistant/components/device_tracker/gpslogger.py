...
from homeassistant.components.http import CONF_API_PASSWORD, HomeAssistantView
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({vol.Optional(CONF_PASSWORD): cv.string})


async def async_setup_scanner(
    hass: HomeAssistantType, config: ConfigType, async_see, discovery_info=None
):
