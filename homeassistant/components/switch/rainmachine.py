...
class RainMachineProgram(RainMachineSwitch):
    ...
    async def async_added_to_hass(self):
        """Register callbacks."""
        async_dispatcher_connect(self.hass, PROGRAM_UPDATE_TOPIC, self._program_updated)
...
class RainMachineZone(RainMachineSwitch):
    ...
    async def async_added_to_hass(self):
        """Register callbacks."""
        async_dispatcher_connect(self.hass, PROGRAM_UPDATE_TOPIC, self._program_updated)
        async_dispatcher_connect(self.hass, ZONE_UPDATE_TOPIC, self._program_updated)
