...
MEDIA_PLAYER_SCHEMA = vol.Schema({ATTR_ENTITY_ID: cv.entity_ids})
...
async def async_setup(hass, config):
    ...
    component.async_register_entity_service(
        SERVICE_TURN_ON, MEDIA_PLAYER_SCHEMA, "async_turn_on"
    )
    component.async_register_entity_service(
        SERVICE_TURN_OFF, MEDIA_PLAYER_SCHEMA, "async_turn_off"
    )
    component.async_register_entity_service(
        SERVICE_TOGGLE, MEDIA_PLAYER_SCHEMA, "async_toggle"
    )
    component.async_register_entity_service(
        SERVICE_VOLUME_UP, MEDIA_PLAYER_SCHEMA, "async_volume_up"
    )
    component.async_register_entity_service(
        SERVICE_VOLUME_DOWN, MEDIA_PLAYER_SCHEMA, "async_volume_down"
    )
    component.async_register_entity_service(
        SERVICE_MEDIA_PLAY_PAUSE, MEDIA_PLAYER_SCHEMA, "async_media_play_pause"
    )
    component.async_register_entity_service(
        SERVICE_MEDIA_PLAY, MEDIA_PLAYER_SCHEMA, "async_media_play"
    )
    component.async_register_entity_service(
        SERVICE_MEDIA_PAUSE, MEDIA_PLAYER_SCHEMA, "async_media_pause"
    )
    component.async_register_entity_service(
        SERVICE_MEDIA_STOP, MEDIA_PLAYER_SCHEMA, "async_media_stop"
    )
    component.async_register_entity_service(
        SERVICE_MEDIA_NEXT_TRACK, MEDIA_PLAYER_SCHEMA, "async_media_next_track"
    )
    component.async_register_entity_service(
        SERVICE_MEDIA_PREVIOUS_TRACK, MEDIA_PLAYER_SCHEMA, "async_media_previous_track"
    )
    component.async_register_entity_service(
        SERVICE_CLEAR_PLAYLIST, MEDIA_PLAYER_SCHEMA, "async_clear_playlist"
    )
    component.async_register_entity_service(
        SERVICE_VOLUME_SET,
    ...
    component.async_register_entity_service(
        SERVICE_SELECT_SOURCE, MEDIA_PLAYER_SELECT_SOURCE_SCHEMA, "async_select_source"
    )
    component.async_register_entity_service(
    ...
    component.async_register_entity_service(
        SERVICE_SHUFFLE_SET, MEDIA_PLAYER_SET_SHUFFLE_SCHEMA, "async_set_shuffle"
    )
...
class MediaPlayerDevice(Entity):
    ...
    async def async_volume_down(self):
        ...
        if self.volume_level > 0:
            await self.async_set_volume_level(max(0, self.volume_level - .1))
