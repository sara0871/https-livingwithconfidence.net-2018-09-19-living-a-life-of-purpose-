...
from .util import convert_to_float, temperature_to_homekit, density_to_air_quality
...
class CarbonDioxideSensor(HomeAccessory):
    ...
    def __init__(self, *args):
        ...
        self.char_co2 = serv_co2.configure_char(CHAR_CARBON_DIOXIDE_LEVEL, value=0)
