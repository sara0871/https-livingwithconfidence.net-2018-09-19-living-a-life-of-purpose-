...
SWITCH_TYPES = {TYPE_OUTLET: "Outlet", TYPE_SWITCH: "Switch"}
...
async def async_setup(hass, config):
    ...
    homekit = HomeKit(hass, name, port, ip_address, entity_filter, entity_config)
...
def get_accessory(hass, driver, state, aid, config):
    ...
    if not aid:
        _LOGGER.warning(
            'The entitiy "%s" is not supported, since it '
...
class HomeKit:
    ...
    def __init__(self, hass, name, port, ip_address, entity_filter, entity_config):
