...
class MiroboVacuum(StateVacuumDevice):
    ...
    def async_stop(self, **kwargs):
        ...
        yield from self._try_command("Unable to stop: %s", self._vacuum.stop)
    ...
    def async_return_to_base(self, **kwargs):
        ...
        yield from self._try_command("Unable to return home: %s", self._vacuum.home)
    ...
    @asyncio.coroutine
    def async_remote_control_move_step(
