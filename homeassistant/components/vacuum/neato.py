...
class NeatoConnectedVacuum(StateVacuumDevice):
    ...
    def update(self):
        ...
        self.clean_area = self._mapdata[self.robot.serial]["maps"][0]["cleaned_area"]
        self.clean_suspension_charge_count = self._mapdata[self.robot.serial]["maps"][
            0
        ]["suspended_cleaning_charging_count"]
        self.clean_suspension_time = self._mapdata[self.robot.serial]["maps"][0][
            "time_in_suspended_cleaning"
        ]
        self.clean_battery_start = self._mapdata[self.robot.serial]["maps"][0][
            "run_charge_at_start"
        ]
        self.clean_battery_end = self._mapdata[self.robot.serial]["maps"][0][
            "run_charge_at_end"
        ]
