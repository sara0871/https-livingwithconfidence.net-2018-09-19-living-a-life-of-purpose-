...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_INITIAL_OPERATION_MODE): vol.In([STATE_AUTO, STATE_OFF]),
...
class GenericThermostat(ClimateDevice):
    ...
    def __init__(
        ...
        async_track_state_change(hass, heater_entity_id, self._async_switch_changed)
    ...
    def async_added_to_hass(self):
        ...
        if old_state is not None:
            ...
            if (
                self._initial_operation_mode is None
