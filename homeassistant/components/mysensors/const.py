...
MYSENSORS_CONST_SCHEMA = {
    ...
    "S_SPRINKLER": [BINARY_SENSOR_SCHEMA, {PLATFORM: "switch", TYPE: "V_STATUS"}],
    "S_WATER_LEAK": [BINARY_SENSOR_SCHEMA, {PLATFORM: "switch", TYPE: "V_ARMED"}],
    "S_SOUND": [
    ...
    "S_GPS": [DEVICE_TRACKER_SCHEMA, {PLATFORM: "sensor", TYPE: "V_POSITION"}],
