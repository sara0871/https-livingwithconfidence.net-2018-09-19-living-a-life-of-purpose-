...
from homeassistant.const import ATTR_ATTRIBUTION, ATTR_STATE, CONF_MONITORED_CONDITIONS
...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    data = PollenComData(
        Client(config[CONF_ZIP_CODE], websession), config[CONF_MONITORED_CONDITIONS]
    )
