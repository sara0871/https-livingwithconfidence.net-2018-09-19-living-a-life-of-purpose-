...
class WUDailySimpleForecastSensorConfig(WUSensorConfig):
    ...
    def __init__(
        self, friendly_name, period, field, wu_unit=None, ha_unit=None, icon=None
    ):
        """Constructor.
...
class WUAlmanacSensorConfig(WUSensorConfig):
    ...
    def __init__(
        self, friendly_name, field, value_type, wu_unit, unit_of_measurement, icon
    ):
        """Constructor.
...
SENSOR_TYPES = {
    ...
    "temp_high_1d_c": WUDailySimpleForecastSensorConfig(
        "High Temperature Today", 0, "high", "celsius", TEMP_CELSIUS, "mdi:thermometer"
    ),
    ...
    "temp_low_1d_c": WUDailySimpleForecastSensorConfig(
        "Low Temperature Today", 0, "low", "celsius", TEMP_CELSIUS, "mdi:thermometer"
    ),
    "temp_low_2d_c": WUDailySimpleForecastSensorConfig(
        "Low Temperature Tomorrow", 1, "low", "celsius", TEMP_CELSIUS, "mdi:thermometer"
    ),
