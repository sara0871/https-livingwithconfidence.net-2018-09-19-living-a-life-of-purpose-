...
SENSOR_TYPES = {
    "solar": ["Solar", "mdi:white-balance-sunny", "local", "W", "solar"],
    "active_power": ["Active Power", "mdi:power-plug", "local", "W", "active_power"],
    ...
    "alwayson_today": ["Always On Today", "mdi:gauge", "remote", "kWh", "alwaysOn"],
    "solar_today": ["Solar Today", "mdi:white-balance-sunny", "remote", "kWh", "solar"],
    "power_today": ["Power Today", "mdi:power-plug", "remote", "kWh", "consumption"],
