...
from homeassistant.const import ATTR_BATTERY_LEVEL, ATTR_VOLTAGE, DEVICE_CLASS_BATTERY
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    def async_add_sensor(sensors):
        ...
        for sensor in sensors:
            if sensor.type in DECONZ_SENSOR and not (
...
class DeconzBattery(Entity):
    ...
    def device_state_attributes(self):
        ...
        attr = {ATTR_EVENT_ID: slugify(self._sensor.name)}
        return attr
