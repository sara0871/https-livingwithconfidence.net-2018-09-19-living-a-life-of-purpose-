...
DEFAULT_SENSORS = ["device_information.WanIPAddress", "device_signal.rssi"]
...
class HuaweiLteSensor(Entity):
    ...
    def unique_id(self) -> str:
        ...
        return "{}_{}".format(self.path, self.data["device_information.SerialNumber"])
