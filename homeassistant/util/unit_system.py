...
VOLUME_UNITS = [VOLUME_GALLONS, VOLUME_FLUID_OUNCE, VOLUME_LITERS, VOLUME_MILLILITERS]
...
class UnitSystem:
    ...
    def __init__(
        self, name: str, temperature: str, length: str, volume: str, mass: str
    ) -> None:
    ...
    def length(self, length: Optional[float], from_unit: str) -> float:
        ...
        return distance_util.convert(length, from_unit, self.length_unit)
...
METRIC_SYSTEM = UnitSystem(
    CONF_UNIT_SYSTEM_METRIC, TEMP_CELSIUS, LENGTH_KILOMETERS, VOLUME_LITERS, MASS_GRAMS
)
